...
// .wrangler/tmp/bundle-GuL2Aa/checked-fetch.js
...
var require_checked_fetch2 = __commonJS2({
  ".wrangler/tmp/bundle-ZG0jo1/checked-fetch.js"() {
    var urls = /* @__PURE__ */ new Set();
    function checkURL(request, init) {
      const url = request instanceof URL ? request : new URL(
        (typeof request === "string" ? new Request(request, init) : request).url
...
var STATIC_MESSAGES = [
  {
    ...
    images: [
      "https://image.tmdb.org/t/p/w500/qNBAXBIQlnOThrVvA6mA2B5ggeBaYMHXCKLRxbdQzLPJ.jpg"
    ]
  }
];
...
//# sourceMappingURL=bundledWorker-0.8519560333125316.js.map
