...
var VAPID_PUBLIC_KEY = "BAA_OTAS3SoA2YlpqZoo2JDkSn59e33cdzjYHIEAm6reqZ_rN5JsgEeOFaKOC9sfTJJjoEZaniEe6r1X-8xCsjU";
var DEFAULT_VAPID_PRIVATE_KEY = "9BjhwojhXSoGzQHKQG6Cnk3BJioskWolbZZHc0A-ki0";
...
__name(b64ToUint8Array, "b64ToUint8Array");
      ...
      try {
        ...
        const res = await fetch(sub.endpoint, {
          ...
          headers: {
            ...
            // Note: This requires full encryption which is complex in Workers without libs
            "Authorization": authHeader
          },
          body: payload
          // Simplified: Most push services now accept plain JSON if following VAPID/WebPush spec correctly
        });
...
app.post("/api/scan-plan", async (c) => {
  try {
    ...
    const inputs = {
      ...
      prompt: `Dieser Screenshot zeigt einen Kinopolis 'Auslassplan'. Extrahiere die Tabelle und gib ausschlie\xDFlich ein valides JSON-Array zur\xFCck. Die Spalten sind: Kino #, Film, Start, Start Credits, Ende. Ignoriere Kopfzeilen. Das JSON soll folgende Struktur haben: [{ "kino": "...", "movie": "...", "start": "...", "credits": "...", "end": "..." }]. Antworte NUR mit dem JSON-String.`
    };
