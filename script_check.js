        ...
        function showToast(msg, isError = false) {
            ...
            t.style.background = isError ? 'rgba(231, 76, 60, 0.95)' : 'rgba(46, 204, 113, 0.95)';
        ...
        async function fetchLocations() {
            try {
                ...
                selector.addEventListener('change', (e) => {
                    ...
                    if (completedAuslaesse && typeof completedAuslaesse.clear === 'function') completedAuslaesse.clear();
        ...
        // --- PREMIUM SOFT CHIME JINGLE ---
        function playStartupSound() {
            try {
                const audio = new Audio('./startup.mp3');
                audio.volume = 0.5;
                audio.play().then(() => {
                    console.log("AUDIO: Harmonious Chime played");
                    // Visual feedback for Test Button
                    const btn = document.querySelector('button[onclick="playStartupSound()"]');
                    if (btn) {
                        const originalText = btn.innerText;
                        btn.innerText = '✨ Harmonisch!';
